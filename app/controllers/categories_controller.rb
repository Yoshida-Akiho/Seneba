class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to @category, notice: '登録完了しました' }
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to @category, notice: '変更完了しました' }
  ...
  def destroy
    @category.destroy
    respond_to do |format|
      format.html { redirect_to categories_url, notice: '削除完了しました' }
